...
it("emr.v20190103.ModifyInspectionSettings", async function () {
    try {
       const data = await client.ModifyInspectionSettings({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("emr.v20190103.DescribeEMREventList", async function () {
    try {
       const data = await client.DescribeEMREventList({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("emr.v20190103.DescribeSparkApplications", async function () {
    try {
       const data = await client.DescribeSparkApplications({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
