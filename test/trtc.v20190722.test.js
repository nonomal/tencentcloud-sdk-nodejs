...
it("trtc.v20190722.CreateLiveStreamModeration", async function () {
    try {
       const data = await client.CreateLiveStreamModeration({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("trtc.v20190722.DescribeLiveStreamModeration", async function () {
    try {
       const data = await client.DescribeLiveStreamModeration({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("trtc.v20190722.DeleteCloudTranscription", async function () {
    try {
       const data = await client.DeleteCloudTranscription({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("trtc.v20190722.DescribeCloudTranscription", async function () {
    try {
       const data = await client.DescribeCloudTranscription({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("trtc.v20190722.DeleteLiveStreamModeration", async function () {
    try {
       const data = await client.DeleteLiveStreamModeration({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("trtc.v20190722.CreateCloudTranscription", async function () {
    try {
       const data = await client.CreateCloudTranscription({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
