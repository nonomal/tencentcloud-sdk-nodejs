...
it("apm.v20210622.DescribeRelatedServicesOnTrace", async function () {
    try {
       const data = await client.DescribeRelatedServicesOnTrace({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("apm.v20210622.DescribeTopologyNew", async function () {
    try {
       const data = await client.DescribeTopologyNew({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
