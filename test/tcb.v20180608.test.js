...
it("tcb.v20180608.ListPGUserMigrations", async function () {
    try {
       const data = await client.ListPGUserMigrations({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.CreateCloudApp", async function () {
    try {
       const data = await client.CreateCloudApp({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.RepairPGUserMigrationHistory", async function () {
    try {
       const data = await client.RepairPGUserMigrationHistory({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.DescribeResourcePermission", async function () {
    try {
       const data = await client.DescribeResourcePermission({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.DeleteCloudApp", async function () {
    try {
       const data = await client.DeleteCloudApp({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.DescribeCloudAppVersion", async function () {
    try {
       const data = await client.DescribeCloudAppVersion({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.PreviewPGUserMigrations", async function () {
    try {
       const data = await client.PreviewPGUserMigrations({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.DeleteCloudAppVersion", async function () {
    try {
       const data = await client.DeleteCloudAppVersion({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("tcb.v20180608.DescribeCloudAppCosInfo", async function () {
    try {
       const data = await client.DescribeCloudAppCosInfo({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
