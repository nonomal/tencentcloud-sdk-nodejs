...
it("waf.v20180125.DeleteOwaspWhiteRule", async function () {
    try {
       const data = await client.DeleteOwaspWhiteRule({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.DescribeApiAggregateTopN", async function () {
    try {
       const data = await client.DescribeApiAggregateTopN({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.DescribeTopics", async function () {
    try {
...
it("waf.v20180125.CreateOwaspWhiteRule", async function () {
    try {
       const data = await client.CreateOwaspWhiteRule({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.ModifyOwaspRuleStatus", async function () {
    try {
       const data = await client.ModifyOwaspRuleStatus({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.DescribeOwaspWhiteRules", async function () {
    try {
       const data = await client.DescribeOwaspWhiteRules({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.ModifyOwaspRuleTypeStatus", async function () {
    try {
       const data = await client.ModifyOwaspRuleTypeStatus({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.DescribeOwaspRules", async function () {
    try {
       const data = await client.DescribeOwaspRules({})
       expect(data).to.be.ok
    } catch(error) {
      expect(error.requestId).to.be.ok
      expect(error.code).to.be.ok
...
it("waf.v20180125.DeleteExport", async function () {
    try {
