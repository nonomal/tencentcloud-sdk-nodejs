...
启动云端转录功能。
     */
  async CreateCloudTranscription(
    req: CreateCloudTranscriptionRequest,
    cb?: (error: string, rep: CreateCloudTranscriptionResponse) => void
  ): Promise<CreateCloudTranscriptionResponse> {
