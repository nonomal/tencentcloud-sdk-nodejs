 ...
 */
export interface VerifyBizLicenseEnterprise3Response {
  /**
 ...
 */
export interface MultimodalDocParseResponse {
  /**
 ...
 */
export interface MultimodalDocParseRequest {
  /**
...
export interface PermitOCRRequest {
  /**
   * <p>图片的 Base64 值。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经Base64编码后不超过 7M。图片下载时间不超过 3 秒。图片的 ImageUrl、ImageBase64 必须提供一个，如果都提供，只使用 ImageUrl。</p>
   */
  ImageBase64?: string
  /**
   * <p>图片的 Url 地址。支持的图片格式：PNG、JPG、JPEG，暂不支持 GIF 格式。支持的图片大小：所下载图片经 Base64 编码后不超过 7M。图片下载时间不超过 3 秒。图片存储于腾讯云的 Url 可保障更高的下载速度和稳定性，建议图片存储于腾讯云。非腾讯云存储的 Url 速度和稳定性可能受一定影响。</p>
   */
  ImageUrl?: string
  /**
   * <p>是否返回头像照片，默认为 false</p>
   */
  CropPortrait?: boolean
}
 ...
 */
export interface SubmitQuestionSplitJobResponse {
  /**
   * <p>任务唯一ID。由服务端生成。</p>
   */
  JobId?: string
 ...
 */
export interface VerifyBizLicenseEnterprise3Request {
  /**
   * <p>统一社会信用代码</p>
   */
  CreditCode: string
 ...
 */
export interface SubmitQuestionSplitJobRequest {
  /**
 ...
 */
export interface DescribeQuestionSplitJobResponse {
  /**
   * <p>切题详情</p>
   */
  QuestionInfo?: Array<QuestionInfo>
...
注意：此字段可能返回 null，表示取不到有效值。
   ...
   */
  CoordPageIndex?: Array<number | bigint>
}

/**
 * DescribeQuestionSplitJob请求参数结构体
 */
export interface DescribeQuestionSplitJobRequest {
  /**
   * <p>任务唯一ID。由服务端生成。</p>
   */
  JobId?: string
