...
export interface CreateAICallRequest {
   ...
   */
  TransferToAgentEnable?: boolean
  /**
   * <p>TransferToAgentEnable为true的时候生效: 转智能体配置</p>
   */
  TransferToAgentItems?: Array<TransferToAgentItem>
  /**
 ...
 * 转接智能体配置
 */
export interface TransferToAgentItem {
  /**
