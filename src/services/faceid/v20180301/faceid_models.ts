...
export interface MobileStatusResponse {
  /**
   * <p>认证结果码，收费情况如下。</p><ul><li>收费结果码：<br>0：成功。</li><li>不收费结果码：<br>-1：未查询到结果。<br>-2：手机号格式不正确。<br>-3：验证中心服务繁忙。<br>-4：认证次数超过当日限制，请次日重试。<br>-13：该号段不支持验证</li></ul>
   */
  Result?: string
  /**
   * <p>业务结果描述。</p>
