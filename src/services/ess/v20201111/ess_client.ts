...
import {
  ...
  FillError,
  CancelOrganizationFlowsRequest,
  CreateStaffResult,
  Recipient,
  VerifyPdfRequest,
  ...
  Agent,
  DescribeFileConvertTaskRequest,
  CallbackInfo,
...
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
     */
  async CreateFileConvertTask(
    req: CreateFileConvertTaskRequest,
    cb?: (error: string, rep: CreateFileConvertTaskResponse) => void
  ): Promise<CreateFileConvertTaskResponse> {
...
5. 若原合同有填写控件，且当前经办人已经完成填写，则不支持进行转交。
6. 若当前经办人已签署完成，或者处于签署流程中，或合同处于完成态（例如：签署完成，拒签，撤销，过期等），则不支持进行转交。
     */
...
![image](https://qcloudimg.tencent-cloud.cn/raw/bb35c9cfa453d28eade16df36221f313.png)
     */
  async DescribeFileConvertTask(
    req: DescribeFileConvertTaskRequest,
    cb?: (error: string, rep: DescribeFileConvertTaskResponse) => void
  ): Promise<DescribeFileConvertTaskResponse> {
...
2. 仅支持5份PDF文件批量发起（一份PDF对应一个审查任务）
     */
  async CreateBatchContractReviewTask(
    req: CreateBatchContractReviewTaskRequest,
...
![image](https://qcloudimg.tencent-cloud.cn/raw/8cb6c8707a3b8c86b55e47fd8d23b30a/a3333.png)
  ...
  async DescribeContractReviewTask(
    req: DescribeContractReviewTaskRequest,
    cb?: (error: string, rep: DescribeContractReviewTaskResponse) => void
  ): Promise<DescribeContractReviewTaskResponse> {
...
```
     */
  async CreateRequestWithEncryption(
    req: CreateRequestWithEncryptionRequest,
    cb?: (error: string, rep: CreateRequestWithEncryptionResponse) => void
  ): Promise<CreateRequestWithEncryptionResponse> {
    return this.request("CreateRequestWithEncryption", req, cb)
  }
...
![image](https://qcloudimg.tencent-cloud.cn/raw/5e69f6e11859972d466900040f68c105.png)
  ...
  async DescribeOrganizationVerifyStatus(
    req: DescribeOrganizationVerifyStatusRequest,
    cb?: (error: string, rep: DescribeOrganizationVerifyStatusResponse) => void
  ): Promise<DescribeOrganizationVerifyStatusResponse> {
...
- 返回的FlowGroupId 为临时id，只有在页面内成功发起后FlowGroupId才会有效。
  ...
  /**
     * 全量撤销企业所有签署中的合同，单次任务最多支持撤销3000份合同。
...
- 撤销后可以看合同PDF内容的人员： 发起方的超管， 发起方自己，发起方撤销合同的操作人员，已经签署合同、已经填写合同、邀请填写已经补充信息的参与人员， 其他参与人员看不到合同的内容。
     */
  async CancelOrganizationFlows(
    req: CancelOrganizationFlowsRequest,
    cb?: (error: string, rep: CancelOrganizationFlowsResponse) => void
  ): Promise<CancelOrganizationFlowsResponse> {
    return this.request("CancelOrganizationFlows", req, cb)
  }
