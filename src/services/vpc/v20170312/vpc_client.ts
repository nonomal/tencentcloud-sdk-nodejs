...
import {
  ...
  DescribeCcnPolicyBasedRoutingRuleResponse,
  ...
  ModifyCcnPolicyBasedRoutingNextHopAttributeRequest,
  ...
  DeleteCcnPolicyBasedRoutingRuleResponse,
  ...
  CreateCcnPolicyBasedRoutingRulesResponse,
  ...
  ModifyCcnPolicyBasedRoutingRuleAttributeResponse,
  ...
  DeleteCcnPolicyBasedRoutingNextHopResponse,
  ...
  DescribeCcnPolicyBasedRoutingNextHopRequest,
  Ipv6Address,
  ...
  DescribeCcnPolicyBasedRoutingRuleRequest,
  ...
  CreateCcnPolicyBasedRoutingRulesRequest,
  DhcpIp,
  ...
  ModifyCcnPolicyBasedRoutingRuleAttributeRequest,
  Ip6Translator,
  ...
  DescribeCcnPolicyBasedRoutingNextHopResponse,
...
- 支持对弹性公网 IPv6 和传统弹性公网 IPv6 实例名称进行修改。
   ...
   * 创建云联网策略路由下一跳
   */
  async CreateCcnPolicyBasedRoutingNextHop(
    req: CreateCcnPolicyBasedRoutingNextHopRequest,
    cb?: (error: string, rep: CreateCcnPolicyBasedRoutingNextHopResponse) => void
  ): Promise<CreateCcnPolicyBasedRoutingNextHopResponse> {
...
>
   ...
   */
  async ReplaceRoutePolicyEntries(
    req: ReplaceRoutePolicyEntriesRequest,
    cb?: (error: string, rep: ReplaceRoutePolicyEntriesResponse) => void
  ): Promise<ReplaceRoutePolicyEntriesResponse> {
    return this.request("ReplaceRoutePolicyEntries", req, cb)
  }
...
接口。
   ...
   */
  async DescribeRoutePolicyEntries(
    req: DescribeRoutePolicyEntriesRequest,
    cb?: (error: string, rep: DescribeRoutePolicyEntriesResponse) => void
  ): Promise<DescribeRoutePolicyEntriesResponse> {
   ...
   * 删除云联网策略路由下一跳
   */
  async DeleteCcnPolicyBasedRoutingNextHop(
    req: DeleteCcnPolicyBasedRoutingNextHopRequest,
    cb?: (error: string, rep: DeleteCcnPolicyBasedRoutingNextHopResponse) => void
  ): Promise<DeleteCcnPolicyBasedRoutingNextHopResponse> {
   ...
   */
  async DeleteRoutePolicyAssociations(
    req: DeleteRoutePolicyAssociationsRequest,
    cb?: (error: string, rep: DeleteRoutePolicyAssociationsResponse) => void
  ): Promise<DeleteRoutePolicyAssociationsResponse> {
...
服务商可以查询服务名下的任意 `APPID` 创建的审批单；非服务商，只能查询自己审批单。
   ...
   */
  async ModifyRoutePolicyAttribute(
    req: ModifyRoutePolicyAttributeRequest,
    cb?: (error: string, rep: ModifyRoutePolicyAttributeResponse) => void
  ): Promise<ModifyRoutePolicyAttributeResponse> {
    return this.request("ModifyRoutePolicyAttribute", req, cb)
  }
   ...
   */
  async DeleteRoutePolicyEntries(
    req: DeleteRoutePolicyEntriesRequest,
    cb?: (error: string, rep: DeleteRoutePolicyEntriesResponse) => void
  ): Promise<DeleteRoutePolicyEntriesResponse> {
...
* vpc-max-ula-ipv6-cidrs （每个VPC可创建的ULA IPv6 CIDR个数）。
   ...
   * 更新云联网策略路由下一跳参数
   */
  async ModifyCcnPolicyBasedRoutingNextHopAttribute(
    req: ModifyCcnPolicyBasedRoutingNextHopAttributeRequest,
    cb?: (error: string, rep: ModifyCcnPolicyBasedRoutingNextHopAttributeResponse) => void
  ): Promise<ModifyCcnPolicyBasedRoutingNextHopAttributeResponse> {
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037)接口。
   ...
   */
  async ResetRoutePolicyEntries(
    req: ResetRoutePolicyEntriesRequest,
    cb?: (error: string, rep: ResetRoutePolicyEntriesResponse) => void
  ): Promise<ResetRoutePolicyEntriesResponse> {
    return this.request("ResetRoutePolicyEntries", req, cb)
  }
...
>
   ...
   */
  async ReplaceRoutePolicyAssociations(
    req: ReplaceRoutePolicyAssociationsRequest,
    cb?: (error: string, rep: ReplaceRoutePolicyAssociationsResponse) => void
  ): Promise<ReplaceRoutePolicyAssociationsResponse> {
    return this.request("ReplaceRoutePolicyAssociations", req, cb)
  }
...
>
   ...
   * 删除云联网策略路由匹配规则
   */
  async DeleteCcnPolicyBasedRoutingRule(
    req: DeleteCcnPolicyBasedRoutingRuleRequest,
    cb?: (error: string, rep: DeleteCcnPolicyBasedRoutingRuleResponse) => void
  ): Promise<DeleteCcnPolicyBasedRoutingRuleResponse> {
...
接口。
   ...
   * 创建云联网策略路由匹配规则
   */
  async CreateCcnPolicyBasedRoutingRules(
    req: CreateCcnPolicyBasedRoutingRulesRequest,
    cb?: (error: string, rep: CreateCcnPolicyBasedRoutingRulesResponse) => void
  ): Promise<CreateCcnPolicyBasedRoutingRulesResponse> {
...
单个请求中只能替换单个方向的一条规则, 必须要指定索引（PolicyIndex）。
   ...
   */
  async CreateRoutePolicyAssociations(
    req: CreateRoutePolicyAssociationsRequest,
    cb?: (error: string, rep: CreateRoutePolicyAssociationsResponse) => void
  ): Promise<CreateRoutePolicyAssociationsResponse> {
    return this.request("CreateRoutePolicyAssociations", req, cb)
  }
...
子网段如果还有IP占用且未回收，则子网段无法释放。
   ...
   * 更新云联网策略路由匹配规则参数
   */
  async ModifyCcnPolicyBasedRoutingRuleAttribute(
    req: ModifyCcnPolicyBasedRoutingRuleAttributeRequest,
    cb?: (error: string, rep: ModifyCcnPolicyBasedRoutingRuleAttributeResponse) => void
  ): Promise<ModifyCcnPolicyBasedRoutingRuleAttributeResponse> {
...
在对新建的NAT网关做其他操作前，需先确认此网关已被创建完成（DescribeNatGateway接口返回的实例State字段为AVAILABLE）。
  ...
  async CreateRoutePolicy(
    req: CreateRoutePolicyRequest,
    cb?: (error: string, rep: CreateRoutePolicyResponse) => void
  ): Promise<CreateRoutePolicyResponse> {
    return this.request("CreateRoutePolicy", req, cb)
  }
...
<font color="#FF0000">本接口即将下线，仅供存量用户使用，暂停新增用户。</font>
   ...
   * 查询云联网策略路由匹配规则
   */
  async DescribeCcnPolicyBasedRoutingRule(
    req: DescribeCcnPolicyBasedRoutingRuleRequest,
    cb?: (error: string, rep: DescribeCcnPolicyBasedRoutingRuleResponse) => void
  ): Promise<DescribeCcnPolicyBasedRoutingRuleResponse> {
...
- 如果网关有流量，但调用本接口没有返回数据，请在控制台对应网关详情页确认是否开启网关流量监控。
   ...
   */
  async CreateRoutePolicyEntries(
    req: CreateRoutePolicyEntriesRequest,
    cb?: (error: string, rep: CreateRoutePolicyEntriesResponse) => void
  ): Promise<CreateRoutePolicyEntriesResponse> {
    return this.request("CreateRoutePolicyEntries", req, cb)
  }
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询[DescribeVpcTaskResult](https://cloud.tencent.com/document/api/215/59037) 接口。
   ...
   * 查询云联网策略路由下一跳
   */
  async DescribeCcnPolicyBasedRoutingNextHop(
    req: DescribeCcnPolicyBasedRoutingNextHopRequest,
    cb?: (error: string, rep: DescribeCcnPolicyBasedRoutingNextHopResponse) => void
  ): Promise<DescribeCcnPolicyBasedRoutingNextHopResponse> {
...
本接口是异步完成，如需查询异步任务执行结果，请使用本接口返回的`RequestId`轮询`DescribeVpcTaskResult`接口。
  ...
  async ResetRoutePolicyAssociations(
    req: ResetRoutePolicyAssociationsRequest,
    cb?: (error: string, rep: ResetRoutePolicyAssociationsResponse) => void
  ): Promise<ResetRoutePolicyAssociationsResponse> {
    return this.request("ResetRoutePolicyAssociations", req, cb)
  }
